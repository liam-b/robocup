...
module.exports.PowerSupply = function (output) {
  ...
  this.check = function () {
    ...
    (100 * ((this.battery.measuredVoltage - this.minVoltage) / (this.maxVoltage - this.minVoltage)) > 40) ? this.output.log('check', 'battery ok') : this.output.warn('check', 'battery is low');
  }
}