...
process.stdin.on('keypress', function (str, key) {
  ...
  switch (str) {
    case 'w':
      motors.ratio(motors.FORWARD, 80);
      break;
    case 's':
      motors.ratio(motors.BACKWARD, 80);
      break;
    case 'q':
      motors.ratio(motors.SLIGHT_LEFT, 80);
      break;
    case 'e':
      motors.ratio(motors.SLIGHT_RIGHT, 80);
      break;
    case 'a':
      motors.ratio(motors.HARD_LEFT, 80);
      break;
    case 'd':
      motors.ratio(motors.HARD_RIGHT, 80);
      break;
    case 'x':
      motors.stop();
      break;
