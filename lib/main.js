...
process.stdin.on('keypress', function (str, key) {
  ...
  switch (str) {
    case 'w':
      motors.ratio(motors.FORWARD);
      break;
    case 'd':
      motors.ratio(motors.BACKWARD);
      break;
    case 'q':
      motors.ratio(motors.SLIGHT_LEFT);
      break;
    case 'e':
      motors.ratio(motors.SLIGHT_RIGHT);
      break;
    case 'a':
      motors.ratio(motors.HARD_LEFT);
      break;
    case 'd':
      motors.ratio(motors.HARD_RIGHT);
      break;
    case 'x':
      motors.stop();
      break;
