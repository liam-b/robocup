...
module.exports.SeekerSensor = function (port, output) {
  ...
  this._direction = function () {
    var arr = [
      this.sensor.getValue(1),
      this.sensor.getValue(1) + this.sensor.getValue(2),
      this.sensor.getValue(2),
      this.sensor.getValue(2) + this.sensor.getValue(3),
      this.sensor.getValue(3),
      this.sensor.getValue(3) + this.sensor.getValue(4),
      this.sensor.getValue(4),
      this.sensor.getValue(4) + this.sensor.getValue(5),
      this.sensor.getValue(5)
    ];
