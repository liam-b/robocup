...
module.exports.ColorSensor = function (port, output) {
  ...
  this.mode = function (mode) {
    ...
    if (this.sensor.connected) this.sensor.setProperty('mode', mode);
    else this.output.err('check', 'color sensor is not connected');
  }
...
module.exports.UltrasonicSensor = function (port, output) {
  ...
  this.mode = function (mode) {
    ...
    if (this.sensor.connected) this.sensor.setProperty('mode', mode);
    else this.output.err('check', 'ultrasonic sensor is not connected');
  }
