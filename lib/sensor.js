...
module.exports.ColorSensor = function (port, output) {
  ...
  this.value = function () {
    (this.sensor.connected) ? return this.sensor.getValue(0) : this.output.warn('value', 'color sensor has been disconnected');
  }
...
module.exports.UltrasonicSensor = function (port, output) {
  ...
  this.value = function () {
    (this.sensor.connected) ? return this.sensor.getValue(0) : this.output.warn('value', 'ultrasonic sensor has been disconnected');
  }
