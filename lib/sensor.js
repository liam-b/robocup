...
module.exports.ColorSensor = function (port, output) {
  ...
  this._checkConnected = function (info) {
    ...
    else (this.sensor.connected) ? this.output.log('check', 'sensor ok') : this.output.err('check', 'color sensor is not connected');
...
module.exports.UltrasonicSensor = function (port, output) {
  ...
  this._checkConnected = function (info) {
    ...
    else (this.sensor.connected) ? this.output.log('check', 'sensor ok') : this.output.err('check', 'ultrasonic sensor is not connected');
    return this.sensor.connected;
  }
}